        ...
        return(
            <>
                <div className='checkout-address-form'>
                    ...
                    <label>* Name: </label>
                    <input className="name-input" type="text" name="name" required onChange={props.handleAddressChange} onBlur={props.check}/>
                    <label>* Street Address: </label>
                    <input className="street-input" type="text" name="street" required onChange={props.handleAddressChange} onBlur={props.check}/>
                    <label>Apt #: </label>
                    <input className="apt-input" type='text' name="apt" onChange={props.handleAddressChange} onBlur={props.check}/>
                    <label>* City: </label>
        ...
        return(
            <>
                <div className='checkout-address-form'>
                    ...
                    <label>Apt #: </label>
                    <input className="apt-input" type='text' name="apt" defaultValue={address.apt} onChange={props.handleAddressChange} onBlur={props.check}/>
                    <label>* City: </label>
